s/@@PACKAGE@@/gcc/g
s/@@LANGUAGE@@/C/g
s/@@DEPENDS32@@/binutils-mingw-w64-i686 (>= 2.30~), mingw-w64-i686-dev, gcc-mingw-w64-base (= ${binary:Version})/g
s/@@DEPENDS64@@/binutils-mingw-w64-x86-64 (>= 2.30~), mingw-w64-x86-64-dev, gcc-mingw-w64-base (= ${binary:Version})/g
s/@@RECOMMENDS@@//g
